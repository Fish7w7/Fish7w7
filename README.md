...
---
## Sobre
- Trabalhando em **bots e aplicações desktop**
- Explorando **TypeScript** e **Python**
- JavaScript é minha língua principal
---
## Projetos
...
| [Log-Analyzer](https://github.com/Fish7w7/Log-Analyzer) | Analisa arquivos de log e detecta ataques como brute force e scanners | `Python` `Flask` |
---
## Stack
